...
# Output
my_output <- paste("/data/users/sschaerer/assembly_annotation_course/busco_plots/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('trinity_busco', 'trinity_busco', 'trinity_busco', 'trinity_busco', 'lja_busco', 'lja_busco', 'lja_busco', 'lja_busco', 'flye_busco', 'flye_busco', 'flye_busco', 'flye_busco', 'hifiasm_busco', 'hifiasm_busco', 'hifiasm_busco', 'hifiasm_busco')
...
my_percentage <- c(38.7, 40.7, 3.2, 17.4, 97.8, 1.5, 0.0, 0.7, 97.8, 1.5, 0.0, 0.7, 97.8, 1.5, 0.1, 0.6)
my_values <- c(1779, 1871, 145, 801, 4493, 70, 2, 31, 4493, 71, 2, 30, 4495, 69, 3, 29)
